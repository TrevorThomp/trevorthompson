...
const Side = () => {
	useEffect(() => {
		const timeout = setTimeout(() => {
			let el = document.querySelector(".social-container");
	...
	return (
		<SocialContainer>
			<ul className="social-container">
				<li>
					<StyledIcon href={socialLinks[0].url} target="_blank" title="GitHub">
				...
				<li>
					<StyledIcon href={socialLinks[1].url} target="_blank" title="Twitter">
						<svg viewBox="0 0 512 512">
